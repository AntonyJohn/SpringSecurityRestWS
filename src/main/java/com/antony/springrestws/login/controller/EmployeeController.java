...
public class EmployeeController {
    ...
    public@ResponseBody Employee  retrieveEmployee(@RequestParam("empID") String empID){					
    	LOG.info("Start:ddd: 0456888123ff55fffdsasdfsdfdfffs896EmployeesadfController --> retrieveEmployee()");    	
        emp = new Employee();       
        emp.setId(new Integer(empID));
        Employee obj=employeeService.retrieveEmployee(emp,emp.getId());
        LOG.info("End::asdf 456EmssdfsasdfadfadfployeasdfeController --> retrieveEmployee()");
        return obj;				 
    }
